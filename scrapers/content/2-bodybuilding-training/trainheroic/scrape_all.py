#!/usr/bin/env python3
"""
Scrape all TrainHeroic posts via WP REST API.

Site: trainheroic.com
Estimated posts: ~497
Source tier: tier2
WP Engine + Divi. per_page=100 times out; use per_page=50.
...
DOMAIN = "trainheroic.com"
BASE_URL = "https://www.trainheroic.com/wp-json/wp/v2/posts"
SOURCE_TIER = "tier2"
USER_AGENT = "Mozilla/5.0 (compatible; GymZilla/1.0)"
PER_PAGE = 50


class TrainHeroicScraper(WPScraper):
    """Custom scraper with reduced page size (per_page=100 times out)."""

    def __init__(self, *args, per_page: int = 50, **kwargs):
