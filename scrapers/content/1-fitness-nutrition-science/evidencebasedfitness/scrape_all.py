#!/usr/bin/env python3
"""
Scrape all Evidence Based Fitness articles via WP REST API.

Fetches posts from evidencebasedfitness.net (inactive since 2018,
content still valuable), converts HTML to markdown with frontmatter.
...
# Configuration
# ---------------------------------------------------------------------------
DOMAIN = "evidencebasedfitness.net"
API_BASE = "https://evidencebasedfitness.net/wp-json/wp/v2/posts"
PER_PAGE = 100
USER_AGENT = "Mozilla/5.0 (compatible; GymZilla/1.0)"
DELAY = 1  # seconds between API pages
REQUEST_TIMEOUT = 30
DEFAULT_AUTHOR = "Bryan Chung"
SOURCE_TIER = "tier2"
...
def main():
    ...
    print(f"Evidence Based Fitness Scraper")
